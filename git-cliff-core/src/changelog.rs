...
mod test {
    use super::*;
    use crate::config::{Bump, ChangelogConfig, CommitParser, Remote, RemoteConfig, TextProcessor};
    ...
    fn get_test_data() -> (Config, Vec<Release<'static>>) {
        ...
        let test_release = Release {
            ...
            commits: vec![
                ...
                Commit::new(String::from("tea"), String::from("feat(app): damn right")),
                Commit::new(
                    String::from("0bc123"),
                ...
                Commit::new(String::from("qw3rty"), String::from("doc: update docs")),
                Commit::new(
                    String::from("0bc123"),
                ...
                Commit::new(String::from("qwerty"), String::from("chore: <preprocess>")),
                Commit::new(
                    String::from("qwertz"),
        ...
        let releases = vec![
            ...
            Release {
                ...
                extra: None,
                commits: vec![
                    Commit::new(String::from("abc123"), String::from("feat(app): add xyz")),
                    Commit::new(
                        String::from("abc124"),
                        String::from("docs(app): document zyx"),
                    ),
                    Commit::new(String::from("def789"), String::from("merge #4")),
                    Commit::new(String::from("dev063"), String::from("feat(app)!: merge #5")),
                    Commit::new(String::from("qwerty"), String::from("fix(app): fix abc")),
                    Commit::new(
                        String::from("hjkl12"),
